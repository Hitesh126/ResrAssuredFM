...
public class SignUpRequest {
	...
	// create static inner class as builder
	...
	public static class Builder {
		...
		// create method as same as setter and return current class object
		public Builder username(String username) {
			this.username = username; // Set above instance variable
			// Builder x = new Builder; --> but it create another object of this class
			Builder x = this;
			return x; // Return current object
		}
		...
		// create a method to build --> create Object of above class
